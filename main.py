...
def predict():
    ...
    try:
        ...
        return jsonify({
            ...
            "macd_data": macd_data,
            "kd_data": kd_data,
            "chip_data": chip_chart_data, # 把籌碼資料送給前端
            "ai_analysis": ai_data
        })
    except Exception as e:
