...
@app.route('/')
def home():
    return "AI 戰情室大腦運轉中！(搭載高階防呆與終極解析模組)"
...
def predict():
    ...
    try:
        ...
        chip_info, chip_chart_data, chip_table_data = "無資料", [], []
        ...
        try:
            ...
            ai_data = {"signal": "解析失敗", "pressure": "--", "support": "--", "stop_loss": "--", "path_up": "--", "path_down": "--", "stars": 0, "advice": ["AI 暫時繁忙", "圖表已為您載入", "請稍後重新點擊"]}
